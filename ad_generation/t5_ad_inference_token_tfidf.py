...
def main():
    ...
    tfidf_words_df_0 = pd.read_csv('./top-tfidf-word/top_words_0.0.csv')
    tfidf_words_df_1 = pd.read_csv('./top-tfidf-word/top_words_1.0.csv')
    tfidf_words_df_2 = pd.read_csv('./top-tfidf-word/top_words_2.0.csv')
    tfidf_words_df_3 = pd.read_csv('./top-tfidf-word/top_words_3.0.csv')
    tfidf_words_df_4 = pd.read_csv('./top-tfidf-word/top_words_4.0.csv')
    tfidf_words_df_5 = pd.read_csv('./top-tfidf-word/top_words_5.0.csv')
    tfidf_words_df_6 = pd.read_csv('./top-tfidf-word/top_words_6.0.csv')
    tfidf_words_df_7 = pd.read_csv('./top-tfidf-word/top_words_7.0.csv')
