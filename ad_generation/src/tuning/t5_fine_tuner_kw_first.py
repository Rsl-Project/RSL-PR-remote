...
from src.tuning.tsv_dataset_kw_first import TsvDatasetKwFirst


class T5FineTunerKwFirst(pl.LightningModule):
    ...
    def push(self, model_repo):
        """学習済みモデルをHugging Faceにアップロードする"""
